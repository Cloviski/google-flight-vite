...
async function getFlightDetails(originEntityId, destinationEntityId, date, cabinClass, sortBy) {
  const options = {
    method: "GET",
...
async function fetchFlights(originCity, destinationCity, date, cabinClass, sortBy, setFlights) {
